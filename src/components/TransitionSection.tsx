...
<CircuitBackground  />
        ...
        {/* Neon signs - responsive sizing and positioning */}
        <div className="absolute opacity-40
          sm:top-1/3 sm:right-1/4
          top-1/4 right-[10%]
          sm:w-48 sm:h-48
          w-32 h-32"
        >
          <img
            src="https://shared.cloudflare.steamstatic.com/store_item_assets/steam/apps/1091500/ss_b20689e73e3ac19bcc5fad2c18d0353c769de144.1920x1080.jpg?t=1734434803"
            alt="Neon Signs"
            className="w-full h-full object-cover rounded-lg"
          />
        </div>

        {/* Digital artifacts - responsive sizing and positioning */}
        <div className="absolute opacity-30
          sm:bottom-1/4 sm:left-1/3
          bottom-1/3 left-1/4
          sm:w-56 sm:h-56
          w-36 h-36"
        >
          <img
            src="https://shared.cloudflare.steamstatic.com/store_item_assets/steam/apps/1091500/ss_284ba40590de8f604ae693631c751a0aefdc452e.1920x1080.jpg?t=1734434803"
            alt="Digital Pattern"
            className="w-full h-full object-cover rounded-lg "
          />
        </div>
